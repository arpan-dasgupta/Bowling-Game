...
public class SaveGame {
    ...
    public static void saveGame(String gameName, Vector<? extends Object> bowlers, int[][] cumulScores, int[] curScores,
            int[][] finalScores, int gameNumber, int count, int frame)
    ...
    // AppendableObjectOutputStream obj = new
    // AppendableObjectOutputStream(out,append);
    // obj.writeObject(sd);
    // obj.close();
    // out.close();
    // }
    ...
    public static void saveGame(SaveData sd) throws IOException {
    ...
    public static SaveData loadGames(String gameName) throws IOException, ClassNotFoundException {
